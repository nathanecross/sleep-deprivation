function pval=pvalvsNull(readleft1,readright1,readleft2,readright2,permno,wsname)
...
datal2= readleft2;%importdata(readleft2); datal2 = datal2.data();
datar2= readleft2;%importdata(readright2); datar2 = datar2.data();
