% Script to generate Figure 3 in Cross et al. 2021 (PLOS Biology)
% 
...
%% 3.A. Relationships with behaviour
%
...
load('../data/integration/Integration400_7_task-All_stdinf.mat'); HI_7 = HI;
clear HI
...
out = array2table([scorex(:,1), scorey(:,1),deltaFCR,...
                   scorex2(:,1),scorey2(:,1),deltaFCR2]);
...
%% 3.B Associations between change in FCR and change in cognitive peformance

% The scatter plots were created with RStudio. 
% See R scripts "Figure3_ii.R"

%% 3.C & 3.D Plot changes over states
%
%   Within-subjects level models of integration were generated using the following scripts:
%
%   Standard inference statistics of within-subject integration changes: e.g. '../data/stats/HI_stats.mat'           
%       were generated by: '../code/integration/run_integration_std.m'
%
...
% 3.C Functional Clustering Ratio
