...
save(sprintf('../../data/Integration%s_7_task-All.mat',nparc), 'HI');  
...
save(sprintf('../../data/Integration%s_7_17_task-All.mat',nparc),'HI');
...
save(sprintf('../../data/Integration%s_17_task-All.mat',nparc), 'HI');
