...
%% 4.A. Ttests for differences across states
for p=1:NumberOfParcels
    for v = 1:length(vols)
            for z = 1:NumberOfSubjects
...
I = customcolormap([0 0.2 0.35 0.5 0.8 0.9 1], {'#6b1200','#E23603','#FF8D33',  '#000000', '#336EFF', '#336EFF', '#033c9e'});
...
%% Figure 4.B - Parcelwise change in thalamocortical connectivity
...
%% Figure 4.C  Thalamocortical connectivity and integration

clear I17_changevec
times = [{'ses-01','','Control'} 
         {'ses-02','run-01','PreNap'}
         {'ses-02','run-02', 'PostNap'}];
load(sprintf('../data/integration/Integration%_%s_task-All.mat',nparc,nnetw)); HI_17 = HI;
...
%% Figure 4.D Thalamocortical connectivity
